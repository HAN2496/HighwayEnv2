...
from controller.utils import check_possible_lane_changes, get_polygon, Minkowski_sum, signed_distance
    ...
    for k in range(max_steps):
        ...
        for lane_change in possible_lane_changes:
            ...
            for o in obs[1:]:
                ...
                #) < 0.5 * ((obs[0]['vx']-o['vx'])**2 + (obs[0]['vy']-o['vy'])**2) / env.controlled_vehicles[0].ACCELERATION_RANGE[1] + 5.0:
                ) < 50.0:
