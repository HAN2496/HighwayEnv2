...
# from controller.mpc import MPCQP  # ← 현재 canvas에 있는 클래스
...
if __name__ == "__main__":
    ...
    # Assume ref lane = init lane
    mpc = MPC(vehicle, dt, ref_speed=35.0, horizon = 20, ref_lane= env.controlled_vehicles[0].lane_index, init_state = obs[0][[1,2,3,5]], d_safe = 3)
